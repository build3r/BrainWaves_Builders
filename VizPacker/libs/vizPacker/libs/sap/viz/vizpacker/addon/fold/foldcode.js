(function() {
  ...
  function doFold(cm, pos, options, onUnfold) {
    ...
    CodeMirror.on(myWidget, "mousedown", function() {
		myRange.clear();
		if (onUnfold) {
			onUnfold(cm.posFromIndex(range.from));
		}
	});
  ...
  // New-style interface
  CodeMirror.defineExtension("foldCode", function(pos, options, onUnfold) { return doFold(this, pos, options, onUnfold); });
